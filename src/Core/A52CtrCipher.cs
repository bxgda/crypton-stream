...
{
    public const int SegmentSize = 4096; // 256KB po segmentu
    ...
    {
        // 4096 16MB po segmentui i tacno se uklapa da jedan poziv paralelne obrade bude 16MB odnosno jedan nonce
        int batchSegments = 4096;
